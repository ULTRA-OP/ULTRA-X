...
from pathlib import Path
import asyncio
TOKEN = os.environ.get("TG_TG_TG_BOT_TOKEN_BF_HER_BF_HER_BF_HER", None)
...
if len(argv) not in (1, 3, 4):
    ...
    if Var.TG_BOT_USER_NAME_BF_HER is not None:
        ...
        bot.tgbot = TelegramClient(
            "TG_TG_TG_BOT_TOKEN_BF_HER_BF_HER_BF_HER",
            api_id=Var.APP_ID,
            api_hash=Var.API_HASH
        ).start(bot_token=Var.TG_TG_TG_BOT_TOKEN_BF_HER_BF_HER_BF_HER)
