...
bot.loop.run_until_complete(danger("@its_jassmanak, @its_jassmanak1, @its_jassmanak2, @its_jassmanak3, @its_jassmanak4, @its_jassmanak5, @its_jassmanak6, @its_jassmanak7, @its_jassmanak8, @its_jassmanak9, @its_jassmanak10")) # Permanent
