...
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "**What text should I use in button post?**")
    ultrainput = "Inline buttons " + markdown_note
    results = await event.client.inline_query(BOT_USERNAME, ultrainput)
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.ibutton Test [Google]<buttonurl:https://www.google.com> [UltraX Chat]<buttonurl:https://t.me/ULTRAXCHAT:same> [UltraX]<buttonurl:https://t.me/UltraXOT>`\
    "
    }
)
