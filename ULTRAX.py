...
token = os.environ.get("TG_TG_TG_TG_BOT_TOKEN_BF_HER_BF_HER_BF_HER_BF_HER", None)
...
ALIVE_TG_BOT_USER_NAME_BF_HER = os.environ.get("ALIVE_TG_BOT_USER_NAME_BF_HER", None)
devs = devs
ID = ID
id = id
